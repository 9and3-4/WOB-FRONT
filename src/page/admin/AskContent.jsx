...
const AskContent = () => {
  ...
  // 맵 돌릴 리스트
  const [boardList, setBoardList] = useState([]); // 채팅내용으로 바꾸기
  ...
  const closeModal = () => {
    ...
    useEffect(() => {
      ...
      // 게시판 목록 (페이지나누기) -(boardList 채팅내용으로바꾸기)
      useEffect(() => {
  ...
  // 게시글 활성화 또는 비활성화 요청 보내기(채팅내용으로 바꾸기)
  ...
  return (
    <BoardContainer>
      ...
      <div className="lists">
        ...
        <Buttons>
          <button onClick={() => handleClick("/AskContents")}>채팅방새로입장</button>
