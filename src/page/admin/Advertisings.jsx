...
const AdminBoardRegistration = () => {
      const [name, setName] = useState(""); // 광고이름
      const [names, setNames] = useState(""); // 광고내용
    ...
    return (
      <Container>
        ...
        {/* 광고이름 쓰는 란 */}
          <FieldContainer>
            <StyledLabel htmlFor="title">광고 이름</StyledLabel>
            <StyledInput
              type="text"
              id="title"
              name="title"
          ...
          {/* 광고 사진 업로드란 */}
            <FileUploadContainer>
              <StyledLabel2 htmlFor="title">광고 사진</StyledLabel2>
          ...
          {/* 광고 내용 업로드란  - 광고 내용으로 바꾸기!!!!!!!!!*/}
          <FileUploadContainer>
              <StyledLabel2 htmlFor="title">광고 내용</StyledLabel2>
              <StyledInput2 
              type="text"
              id="text"
              name="text"
              ...
              <UploadButton onClick={handleNameChange2}>Upload</UploadButton>
          </FileUploadContainer>
