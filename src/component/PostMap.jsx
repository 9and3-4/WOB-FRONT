  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      window.kakao.maps.load(() => {
        ...
        const options = {
          // 지도를 생성할 때 필요한 기본 옵션
          center: new window.kakao.maps.LatLng(37.5665, 126.978), // 초기 중심 좌표 (위도, 경도)
          level: 5, // 초기 확대 수준
        };
        ...
        const iwContent =
          '<div style="padding:5px; font-size: 14px;">Hello!😀<br><a href="https://map.kakao.com/link/map/시청역,37.5665, 126.9780" style="color:black; text-decoration: none" target="_blank">지도보기</a> <a href="https://map.kakao.com/link/to/37.5665, 126.9780" style="color:black; text-decoration: none" target="_blank">길찾기</a></div>';
        const iwPosition = new kakao.maps.LatLng(37.5665, 126.978); // 인포윈도우 표시될 위치를 설정
